...
**Имя агента:** document-assembler

**Входные файлы (только ЧТЕНИЕ):**
- все `output/sections/section_*.md`
...
- ❌ не редактировать разделы на месте (section_*.md);
- ❌ не создавать `lecture_final.md`, `review_report.md`, `image_prompts.md`.
